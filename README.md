Basically this mod allows to add non magic chars in TES Arena to use spell book + I think I kinda enabled flag for critical hit which shouldn't be a big problem.
